        ...
        <div>
          ...
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <span className={`px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-100`}>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex space-x-2">
            ...
            {task.parentTaskId && (
              <Button
                variant="outline"
                onClick={() => onPromoteToParent(task.id)}
              >
                Promote to Parent
              </Button>
            )}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setSubtaskData(prev => ({ ...prev, priority: e.target.value }))}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                >
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              <Button
                ...
                disabled={!subtaskData.title.trim()}
              >
                Create Subtask
              </Button>
            </div>
