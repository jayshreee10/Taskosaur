...
export default function TimeTracking({ task, onLogTime, onUpdateTime, onDeleteTime }: TimeTrackingProps) {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setTimeLogData(prev => ({ ...prev, timeSpent: parseInt(e.target.value) || 0 }))}
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              <Button
                ...
                disabled={timeLogData.timeSpent === 0}
              >
                Log Time
              </Button>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditData(prev => ({ ...prev, timeSpent: parseInt(e.target.value) || 0 }))}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  min="0"
                  step="1"
                />
