...
import { CheckCircle, Users, Zap, Shield, Sparkles, ArrowRight, TrendingUp, Award } from 'lucide-react';

const features = [
  {
    icon: CheckCircle,
    title: 'Smart Task Management',
    description: 'AI-powered task organization with intelligent prioritization and deadline tracking.',
    metric: '40% faster'
  },
  {
    icon: Users,
    title: 'Seamless Collaboration',
    description: 'Real-time team sync with advanced communication and file sharing tools.',
    metric: '99.9% uptime'
  },
  {
    icon: Zap,
    title: 'Lightning Performance',
    description: 'Blazing fast interface built for maximum productivity and efficiency.',
    metric: '<100ms load'
  },
  {
    icon: Shield,
      ...
      <div className="relative z-10 max-w-2xl mx-auto lg:mx-0">
        ...
        >
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <p className="text-white/70 text-xs lg:text-sm font-medium">Award-winning Project Management</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <span className="text-white text-xs lg:text-sm font-semibold">Streamline your workflow today</span>
          </motion.div>
        </motion.div>
