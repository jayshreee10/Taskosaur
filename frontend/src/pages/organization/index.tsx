...
function CreateOrganizationContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem("currentOrganizationId", result.id);
      router.reload();
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-[var(--background)]">
      <div className="space-y-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-[var(--muted-foreground)] text-xs mt-2 pl-6">
        ...
        <Card className="border-none shadow-sm">
          ...
          <CardContent className="p-6 border-none">
            {isSubmitting ? (
              <Loader text="Fetching Organization Details" />
            ) : (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-[var(--muted-foreground)] mb-3">
                  ...
                  projects, and teams. Once created, you can switch between
                  organizations using the selector in the header to work with
                  different groups or companies.
                </p>
