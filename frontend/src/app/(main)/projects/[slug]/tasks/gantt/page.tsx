...
export default function ProjectTasksGanttPage() {
  ...
  const currentOrganization = typeof window !== 'undefined'
    ...
    const loadData = async () => {
      ...
      try {
        ...
        const projectTasks = tasksData.filter(
          task => task.projectId === projectData?.id
        );
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href={`/${defaultWorkspace.slug}/${currentProject.slug}/tasks/new`}
            passHref
          >
      ...
      <TaskViewTabs currentView="gantt" baseUrl={`/projects/${slug}/tasks`} />
