    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="flex justify-center items-center h-64">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-sm text-[var(--muted-foreground)]">Loading project timeline...</div>
        </div>
      </div>
    </div>
  </div>
...
export default function ProjectTasksGanttPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
      <div className="max-w-7xl mx-auto p-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <div className="flex items-center gap-2 text-sm text-[var(--muted-foreground)] mb-1">
                <Link href={`/${workspaceSlug}`} className="hover:text-[var(--foreground)]">
                  {workspaceData?.name}
                </Link>
                <span>/</span>
                <Link href={`/${workspaceSlug}/${projectSlug}`} className="hover:text-[var(--foreground)]">
                  {projectData?.name}
                </Link>
              </div>
        ...
        {/* View Tabs */}
        <div className="mb-6">
          <TaskViewTabs currentView="gantt" baseUrl={`/${workspaceSlug}/${projectSlug}/tasks`} />
        </div>
