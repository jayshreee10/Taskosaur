...
export default function TimeTrackingPage() {
  ...
  const getTimeStats = () => {
    ...
    const totalTime = filteredEntries.reduce((sum, entry) => sum + entry.timeSpent, 0);
  ...
  const getTaskTimeStats = () => {
    ...
    return Array.from(taskStats.values()).map(stat => ({
      ...stat,
        ...
        {activeTab === 'overview' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-3">
                {taskStats.slice(0, 10).map((task, index) => (
                  <div key={index} className="flex items-center justify-between">
        ...
        {activeTab === 'entries' && (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="p-6">
              ...
              <div className="space-y-3">
                {stats.entries.slice(0, 20).map((entry, index) => (
